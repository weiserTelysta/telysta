<template>
    <transition :name="backgroundIsopenStore.isOpen ? 'rotate-up' : 'rotate-down'" mode="out-in">
        <div class="container-arrow" @click="handleClick">
            <div class="ripple-effect" v-if="showRipple"></div>
            <svg v-show="backgroundIsopenStore.isOpen" t="1739019223177" class="icon" viewBox="0 0 1140 1024" version="1.1"
            ...
            <svg v-show="!backgroundIsopenStore.isOpen" t="1739019195411" class="icon" viewBox="0 0 1140 1024" version="1.1"
